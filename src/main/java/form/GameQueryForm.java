 ...
 */
public class GameQueryForm {

    private static final Logger LOG = Logger.getLogger(GameQueryForm.class.getName());
     ...
     */
    public GameQueryForm filter(Filter filter) {
        if (filter.operator.isInequalityFilter()) {
